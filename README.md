...
| **Bowling Scorecard** | A tool for calculating the score of a game of bowling. The scorecard calculation for bowling is complex and requires thorough consideration of all possible program states. | [Ruby command line version](https://github.com/AdamusBG/bowling-challenge-ruby), [JavaScript browser version](https://github.com/AdamusBG/bowling-challenge) |
